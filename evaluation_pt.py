...
#=======================================================================================================================
# Data 1 Loading
real_1_test = h5py.File(inter_path+'H1_32T4R.mat', 'r')
...
# Data 2 Loading
real_2_test = h5py.File(inter_path+'H2_32T4R.mat', 'r')
...
#=======================================================================================================================
# Data 1 Generating
fake_1 = generator_1(NUM_FAKE_1, submit_path+'generator_1.pth.tar', 'H1_32T4R.mat')
# Data 2 Generating
fake_2 = generator_2(NUM_FAKE_2, submit_path+'generator_2.pth.tar', 'H2_32T4R.mat')
t3 = time.time()
#=======================================================================================================================
#=======================================================================================================================
# Data checking
